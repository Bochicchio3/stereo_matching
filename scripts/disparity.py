...
minDisparity = 16
numDisparities = 64 - minDisparity
blockSize = 5
uniquenessRatio = 1
speckleWindowSize = 3
speckleRange = 3
...
imgL = cv2.imread('./scripts/im2.png',0)
imgR = cv2.imread('./scripts/im6.png',0)

left_disp, right_disp = sgm.sgm(imgL, imgR)
...
def update(sliderValue = 0):
    ...
    cv2.imshow('left_disp_sgm',left_disp)
